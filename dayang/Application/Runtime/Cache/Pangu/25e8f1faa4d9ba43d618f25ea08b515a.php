...
<div class="pd-20">
   ...
   <input type="hidden" name="type" value="<?php echo ($type); ?>"></input>
    ...
    <div class="row cl">
      ...
      <div class="formControls col-6">
       <input type="text" class="input-text" placeholder="" value="<?php echo ($list["type"]); ?>" name="type" id="type">
      </div>   
    </div>
    <div class="row cl">
      <label class="form-label col-2"><span class="c-red">*</span>原价：</label>
      <div class="formControls col-6">
       <input type="text" class="input-text" placeholder="" value="<?php echo ($list["m"]); ?>" name="m" id="m">
      </div>   
    </div>
    <div class="row cl">
      <label class="form-label col-2"><span class="c-red">*</span>第一价格：</label>
      <div class="formControls col-6">
       <input type="text" class="input-text" placeholder="" value="<?php echo ($list["m1"]); ?>" name="m1" id="m1">
      </div>   
    </div>
    <div class="row cl">
      <label class="form-label col-2"><span class="c-red">*</span>人数：</label>
      <div class="formControls col-6">
       <input type="text" class="input-text" placeholder="" value="<?php echo ($list["p1"]); ?>" name="p1" id="p1">
      </div>   
    </div>
     <div class="row cl">
      <label class="form-label col-2"><span class="c-red">*</span>第二价格：</label>
      <div class="formControls col-6">
       <input type="text" class="input-text" placeholder="" value="<?php echo ($list["m2"]); ?>" name="m2" id="m2">
      </div>   
    </div>
    <div class="row cl">
      <label class="form-label col-2"><span class="c-red">*</span>人数：</label>
      <div class="formControls col-6">
       <input type="text" class="input-text" placeholder="" value="<?php echo ($list["p2"]); ?>" name="p2" id="p2">
      </div>   
    </div>
     <div class="row cl">
      <label class="form-label col-2"><span class="c-red">*</span>第三价格：</label>
      <div class="formControls col-6">
       <input type="text" class="input-text" placeholder="" value="<?php echo ($list["m3"]); ?>" name="m3" id="m3">
      </div>   
    </div>
    <div class="row cl">
      <label class="form-label col-2"><span class="c-red">*</span>人数：</label>
      <div class="formControls col-6">
       <input type="text" class="input-text" placeholder="" value="<?php echo ($list["p3"]); ?>" name="p3" id="p3">
      </div>   
    </div>
 ...
 <div class="row cl">
      ...
      <p class="" id="file_upload2"><span>上传</span></p><label>预览：</label><img id="img2" style="hight:64px;width:64px" src="<?php echo (is_img($list["headimg"])); ?>"><input type="hidden"  id="headimg" name="headimg" value="<?php echo (is_img($list["headimg"])); ?>">
 </div>
 ...
 <div class="row cl">
      ...
      <div class="formControls col-8">
        ...
        <script type="text/javascript" >
          UE.getEditor('image')/*,{initialFrameHeight:400,initialFrameWidth:600}*/
        </script>
        <!-- 第三步：用于显示UDEITOR编辑器，可以是<textarea>，也可以是<script>... -->
        <textarea name="image" id="image" style="width:80%px;height:500px"><?php echo ($list["image"]); ?></textarea>
      </div>
    </div>
  ...
  <script type="text/javascript">
      $(function(){
        $('#sub_form2').click(function(){
          ...
          var id="<?php echo ($id); ?>";
          $.post("<?php echo U('Index/do_edit');?>?table=tuan&id="+id,data,function(data){
            if (data>=1) {
              //layer.msg("修改成功");
              alert("修改成功");
