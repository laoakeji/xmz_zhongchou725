...
<aside class="Hui-aside">
	...
	<div class="menu_dropdown bk_2">
		...
		<dl id="menu-system">
			...
			<dd>
				<ul>
					<li><a _href="<?php echo U('Index/llist');?>" href="javascript:void(0)">单品</a></li>
					<li><a _href="<?php echo U('Index/tuan');?>" href="javascript:void(0)">套餐</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-system">
			<dt><i class="Hui-iconfont">&#xe627;</i> 奖品统计<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
			<dd>
				<ul>
					<li><a _href="<?php echo U('Index/prize');?>?type=1" href="javascript:void(0)">单品</a></li>
