				...
				<tr class="text-c">
					...
					<th width="80">ID</th>
 					<th width="80">类型编码</th>
          			<th width="80">名称</th>
          			<th width="120">原价</th>
 					<th width="150">第一价格</th>
 					<th width="150">人数阈值</th>
			        <th width="150">第二价格</th>
			        <th width="150">人数阈值</th>
			        <th width="150">第三价格</th>
			        <th width="150">人数阈值</th>
			        <th width="150">参与人数</th>
			        <th width="120">详情图片</th>
			        <th width="120">顶部图片</th>
			        <th width="120">操作</th>
				</tr>
			</thead>
			<tbody>
				<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="text-c">
					...
					<td><?php echo ($vo["m"]); ?></td>
		          	<td><?php echo ($vo["m1"]); ?></td>
		          	<td><?php echo ($vo["p1"]); ?></td>
		          	<td><?php echo ($vo["m2"]); ?></td>
		          	<td><?php echo ($vo["p2"]); ?></td>
		          	<td><?php echo ($vo["m3"]); ?></td>
		          	<td><?php echo ($vo["p3"]); ?></td>
		          	<td><?php echo ($vo["count"]); ?></td>
					<td><img src="<?php echo ($vo["image"]); ?>" style="width:120px;height: 60px"></td>
          			<td><img src="<?php echo ($vo["headimg"]); ?>" style="width:120px;height: 60px"></td>
					<td class="f-14 td-manage">
						<a style="text-decoration:none" class="ml-5" onClick="admin_edit('编辑','<?php echo U('Index/edit');?>?table=list&type=<?php echo ($type); ?>&id=<?php echo ($vo["id"]); ?>','1000','800')" href="javascript:;" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a>
					</td>
