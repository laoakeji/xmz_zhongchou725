...
<body>
 <style>
  ...
  <div class="screening-select select-2"><a href="javascript:void(0)">￥<?php echo ($list["m"]); ?></a></div>
  <div class="screening-select select-2"><a href="javascript:void(0)"></a></div>
  <div class="screening-select select-4"><a href="javascript:void(0)">￥<?php echo ($list["m1"]); ?></a></div>

    </div>
    <div class="xiangqing2-3">
      <ul>
       <li><span class="sl"><?php echo ($data["now_people"]); ?></span><em>当前人数</em></li>
       <li></li>
       <li><span class="s3"><?php echo ($list["p"]); ?></span><em>指标人数</em></li>
      </ul>
    </div>
	...
	<div class="zhe">
    <div class="zhe-main">
      <span class="l">第<?php echo ($data["tz"]); ?>组</span>
      <span class="r">
        <div class="zhe-main-left">当前价格</div>
        <div class="zhe-main-right"><?php echo ($data["now_money"]); ?></div>
...
if(userName == ""){
 ...
 /*$("#form").submit();*/
/*var p = parseInt("<?php echo ($list["p"]); ?>")-parseInt("<?php echo ($pcount); ?>");*/

 var data=$("#form2").serialize();
  $.post("<?php echo U('Home/Index/tcommit');?>?type=<?php echo ($type); ?>&p=<?php echo ($pcount); ?>",data,function(data){
    //alert(data);
    layer.alert(data,{
...
<script type="text/javascript">
//var Num1=90;//当前数量
var Num1=parseInt("<?php echo ($pcount); ?>");//当前数量
var AllNum1=parseInt("<?php echo ($list["p"]); ?>");//目标数量1
var AllNum2=parseInt("<?php echo ($list["p2"]); ?>");//目标数量2
var AllNum3=parseInt("<?php echo ($list["p3"]); ?>");//目标数量2
